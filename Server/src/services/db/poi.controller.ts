...
export default class POIController {
     ...
     * @param isTurningPoint - optional indicator wether it is possible to turn a vehicle around at this POI
     ...
     * * @param isTurningPoint - indicator wether it is possible to turn a vehicle around at this POI (Optional)
     * @returns POI | null if an error occurs.
     */
