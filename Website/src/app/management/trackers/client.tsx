...
function UpdateTracker({vehicles, trackerList, mutateTrackerList, isLoading}: { vehicles: Vehicle[], trackerList?: Tracker[], mutateTrackerList: KeyedMutator<Tracker[]>, isLoading: boolean }) {
    ...
    const updateTracker: FormEventHandler = async (e) => {
        ...
        const updatePayload: Tracker = {
            id: selTracker,
            vehicleId: nanToUndefined(+trackerVehicle)
        }
...
function AddTracker({vehicles, mutateTrackerList, isLoading}: { vehicles: Vehicle[], mutateTrackerList: KeyedMutator<Tracker[]>, isLoading: boolean}) {
    ...
    const createTracker: FormEventHandler<HTMLFormElement> = async (e) => {
        ...
        const vehicleId = nanToUndefined(+(data.get('trackerVehicle') ?? NaN))
        const updatePayload: Tracker = {
            id,
            vehicleId,
        }
