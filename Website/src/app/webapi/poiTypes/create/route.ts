...
import {createPOIType, createVehicleType} from "@/utils/data";
import {CreatePOIType, UpdateVehicleType} from "@/utils/api";
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const res = await createPOIType(token, payload);
