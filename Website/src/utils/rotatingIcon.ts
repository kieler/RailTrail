...
export default class RotatingVehicleIcon extends L.DivIcon {
	...
	public constructor(
		...
		baseLayerUrl: string = "/vehicle/Vehicle_background_neutral.svg",
		rotatingLayerUrl: string = "/vehicle/Vehicle_heading.svg",
		foregroundUrl: string = "/vehicle/Vehicle_foreground.svg"
	) {
